...
This document outlines how SomPheas manages non-functional requirements (NFRs) - the quality attributes that define how the system performs, scales, and maintains reliability.
